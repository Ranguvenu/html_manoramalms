...
class reportbase {
   ...
   public function build_query($count = false) {
    ...
    function get_all_elements() {
        global $DB; 
        try {
            if (isset($this->mobileservice) && $this->mobileservice == 1) {
                $finalelements = $DB->get_records_sql($this->sql, $this->params, $this->start, '');
            } else {
